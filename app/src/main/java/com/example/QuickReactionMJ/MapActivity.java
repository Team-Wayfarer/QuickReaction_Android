...
public class MapActivity extends AppCompatActivity implements MapView.CurrentLocationEventListener, MapReverseGeoCoder.ReverseGeoCodingResultListener {
    ...
    private Map<Integer, location> spinnerDay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner day = (Spinner) findViewById(R.id.spinner);
...
class location {
    ...
    double longitude;
    int day;
    public location(int day, double latitude, double longitude) {
        this.day = day;
